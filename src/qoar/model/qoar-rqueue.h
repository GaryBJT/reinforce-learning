 ...
 */
#ifndef Qoar_RQUEUE_H
#define Qoar_RQUEUE_H
...
/**
 * \ingroup qoar
 * \brief QOAR route request queue
 *
 * Since QOAR is an on demand routing we queue requests while looking for route.
 */
class RequestQueue
{
  public:
