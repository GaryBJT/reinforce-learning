 ...
 * \ingroup qoar
 *
 * \brief QOAR loopback UDP echo test case
 */
 ...
 * \ingroup qoar-test
 *
 * \brief QOAR Loopback test suite
 */
class QoarLoopbackTestSuite : public TestSuite
{
  public:
    QoarLoopbackTestSuite()
        : TestSuite("routing-qoar-loopback", SYSTEM)
    {
        SetDataDir(NS_TEST_SOURCEDIR);
        // UDP Echo loopback test case
        AddTestCase(new LoopbackTestCase(), TestCase::QUICK);
    }
} g_QoarLoopbackTestSuite; ///< the test suite
